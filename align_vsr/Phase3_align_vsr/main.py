...
@hydra.main(config_path="/work/liuzehua/task/VSR/cnvsrc/conf/vsr2asr/model5/Phase3_vsr2asr_v2", config_name= "train.yaml")
def main(cfg: DictConfig) -> None:
        ...
        decoder_acc_val = ModelCheckpoint(
            monitor="valid_asr2vsr_decoder_acc",
            mode="max",
            dirpath=cfg.save.save_valid_model,
            save_last=True,
            filename="{epoch}-{valid_asr2vsr_decoder_acc:.4f}",
